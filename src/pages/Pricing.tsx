        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 pt-32 pb-24">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">Become a World-Class Traveler</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
                    ...
                    >
                        <Card className="p-8 border-accent/20 bg-accent/[0.03] relative overflow-hidden ring-4 ring-accent/5">
                            <div className="absolute top-0 right-0 p-8 opacity-5">
                                <Globe size={120} />
                            </div>

                            <div className="relative z-10">
                                <h2 className="text-2xl font-bold mb-2">Annual Explorer Plan</h2>
                                ...
                                <p className="text-center text-xs text-muted-foreground">7-day money-back guarantee. Cancel anytime.</p>
                            </div>
                        </Card>
                    </motion.div>
                    ...
                    >
                        {features.map((f, i) => (
                            <div key={i} className="flex gap-4 p-4 rounded-xl hover:bg-secondary/50 transition-colors">
                                <div className={`p-2.5 rounded-lg ${f.bg} ${f.color} shrink-0`}>
                                    <f.icon size={20} />
                                </div>
                                <div>
                                    <h3 className="font-bold text-foreground text-sm uppercase tracking-wide">{f.title}</h3>
