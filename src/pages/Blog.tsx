        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 pt-32 pb-24">
                <div className="max-w-3xl mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">Cultural Chronicles</h1>
                        ...
                        >
                            <Card className="group overflow-hidden border-border bg-background/50 backdrop-blur-sm transition-all hover:border-accent/40">
                                ...
                                <div className="p-6">
                                    ...
                                    <Button variant="ghost" className="p-0 h-auto font-bold text-accent hover:text-accent/80 hover:bg-transparent group/btn">
